...
for sigma = sigma_vals            
    ...
    % Pre-compute shocks
    rng(90212);              
    disp_params = create_params(psi, 0, 0, 0, 0, 0, theta_bar, 0, sigma); % Create params struct for simulation  
    ...
    for gamma = gamma_vals              % Loop over gamma
        for  alpha = alpha_vals         % Loop over alpha
            ...
            % Generate Parameters;
            params                  = create_params(psi, beta, xi, alpha, phi, gamma, theta_bar, A, sigma);
